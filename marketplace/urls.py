...
urlpatterns = [
    ...
    path('tasks/<int:pk>/quoting-appointment/<int:appt_pk>/suggest-alternative/', views.suggest_alternative_appointment_times, name='suggest_alternative_appointment_times'),
    path('tasks/<int:pk>/quoting-appointment/<int:appt_pk>/accept-alternative/<int:slot_pk>/', views.accept_alternative_slot, name='accept_alternative_slot'),
    path('tasks/<int:pk>/quoting-appointment/<int:appt_pk>/decline-alternative/', views.decline_alternative_appointment, name='decline_alternative_appointment'),
